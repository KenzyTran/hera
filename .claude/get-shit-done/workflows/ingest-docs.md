...
```bash
INIT=$(node "C:/Users/trant/projects/hera/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/trant/projects/hera/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
