...
```
Task(
  prompt="Read C:/Users/trant/projects/hera/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/trant/projects/hera/.claude/get-shit-done/templates/SECURITY.md`
