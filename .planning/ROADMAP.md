...
- [ ] **Phase 1: Knowledge Base Foundation** - Apple catalog ingested into Bedrock KB on S3 Vectors, queryable from CLI
...
|-------|----------------|--------|-----------|
| 1. Knowledge Base Foundation | 0/TBD | Not started | - |
